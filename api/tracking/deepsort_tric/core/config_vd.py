...
__C.YOLO.CLASSES              = "./tracking/deepsort_tric/data/classes/vd.names"
...
__C.TRAIN.ANNOT_PATH          = "./tracking/deepsort_tric/data/classes/train_vd.txt"
...
__C.TEST.ANNOT_PATH           = "./tracking/deepsort_tric/data/classes/test_vd.txt"
